...
<body>
  ...
  @endif
@if (session()->has('msj'))
        <div class="alert alert-success" role="alert" style="width: 50%; position:  absolute;top:44% ; left: 25%;">
 ...
 <section style="width: 100%; max-width: 100%; height:100%;max-height: 100%; background: #FFFFFF">
        ...
        <div class="card-header text-center" style="font-size:200%;width: 50%; height: 9.8%; background: #000080; color: rgb(212, 172, 13); position:  absolute;top: 54%; left: 25%;" >{{ __(' Asignar Grupos') }}</div>

        <div style="position: absolute;top: 64%; left: 25%; width: 50%;height:50%; background-color:#aaa">

{!! Form::open(['route'=>['grupos.show','a'],'method'=>'GET','files'=>false]) !!}     {{ csrf_field() }}
