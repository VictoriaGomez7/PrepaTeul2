...
<body>
    <script type="text/javascript">
      ...
      {!! Form::open(['route'=>['materia.store',$materia->Clave_M],'method'=>'POST','files'=>false]) !!}     {{ csrf_field() }}
        ...
        <p><select name="formacion" id="formacion" required="true"  style="font-size:105%; width: 65%; position:  absolute;top:37%; left: 30%"><?php
        ...
        <p><select name="Bachillerato" id="Bachillerato" required style="font-size:110%;width: 65%; position:  absolute;top: 65%; left: 30%" disabled="true">
