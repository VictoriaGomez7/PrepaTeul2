    ...
    @section('frameDocentesTutores')
        ...
        {!!Form::open(['route' => ['RegistrarTutores.store'],'method'=>'POST'])!!}
            ...
            <div style="position: absolute;top: 62%; left: 25%; width: 50%;height:60%; background-color:#aaa">
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre1" name="nombre1"  style="font-size:105%; width: 50%; position:  absolute;top: 15%; left: 10%"/></p>
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre2" name="nombre2"  style="font-size:105%; width: 50%; position:  absolute;top: 30%; left: 10%"/></p>
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre3" name="nombre3"  style="font-size:105%; width: 50%; position:  absolute;top: 45%; left: 10%"/></p>
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre4" name="nombre4"  style="font-size:105%; width: 50%; position:  absolute;top: 60%; left: 10%"/></p>
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre5" name="nombre5"  style="font-size:105%; width: 50%; position:  absolute;top: 75%; left: 10%"/></p>
                ...
                <p><input type="text" placeholder="PROFR. GUSTAVO ROBLES DÍAZ" value="{{ old('nombre') }}" required pattern="[a-zA-ZàáâäãåąčćęèéêëėįìíîïłńòóôöõøùúûüųūÿýżźñçčšžÀÁÂÄÃÅĄĆČĖĘÈÉÊËÌÍÎÏĮŁŃÒÓÔÖÕØÙÚÛÜŲŪŸÝŻŹÑßÇŒÆČŠŽ∂ð ,.'-]{2,48}" id="nombre6" name="nombre6"  style="font-size:105%; width: 50%; position:  absolute;top: 90%; left: 10%"/></p>
