    ...
    @section('frameDocentes')
        ...
        {!!Form::open(['route' => ['Docente.store'],'method'=>'POST'])!!}
            ...
            <div style="position: absolute;top: 62%; left: 25%; width: 50%;height:50%; background-color:#aaa">
                ...
                <p><input type="text" placeholder="31145" value="{{ old('Clave_D') }}" required id="Clave_D" name="Clave_D" style="font-size:105%; width: 65%; position:  absolute;top: 10%; left: 30%"/></p>
