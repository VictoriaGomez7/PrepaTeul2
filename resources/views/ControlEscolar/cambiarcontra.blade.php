...
<div style="position: absolute;top: 15%; left: 05%; width: 90%;height:10%;">
		<div class="input-group input-group-lg" style="padding:05px;  ">
			...
			<p></p>
			<h1></h1>
			<input type="password" class="form-control" name="contra" minlength="8" maxlength="20" placeholder="Nueva Contraseña" id="contra" aria-describedby="sizing-addon1" style="z-index: 0;">
