...
<body>
    <?php
        ...
        $sql = "SELECT Aprobados,Reprobados,Semestre,Materia,Periodo FROM estadistica_semestres";
            ...
            while ($reg=mysqli_fetch_array($result))
        {
            ...
            array_push($Aprobados,$reg['Aprobados']);
            array_push($Reprobados, $reg['Reprobados']);
