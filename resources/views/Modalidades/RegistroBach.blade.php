...
{!! Form::open(['route'=>'Bachillerato.create','method'=>'GET'])!!}
  ...
  <input 
   id="Nombre_B" name="Nombre_B" style="font-size:150%;position: absolute;top: 5%; left: 30%; width: 30%;"
    />
...
<form class="form-group" method="GET" action="/Bachillerato/{{$doc->id}}/edit">
  ...
  <input 
   id="Nombre_B" name="Nombre_B" value="{{$doc->Nombre_B}}" style="font-size:130%; position: absolute;top: 10%; left: 15%;"
    />
