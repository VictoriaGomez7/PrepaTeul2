...
<?php $__env->startSection('content'); ?>
  ...
  <?php if(session()->has('msj')): ?>
    <div class="alert alert-warning" role="alert" style="width: 50%; position:  absolute;top: 43%; left: 25%;z-index: 1;">
      ...
      <strong>¡Incorrecto! </strong><?php echo e(session('msj')); ?>
...
<body>
  ...
  <div class="card-header text-center" style="font-size:200%;width: 50%; height: 9.8%; background: #000080; color: rgb(212, 172, 13); position:  absolute;top: 52%; left: 25%;" ><?php echo e(__('Definir Periodos Parciales')); ?></div> <!-- text-center ES PARA CENTRA EL TEXTO -->
    <div style="position: absolute;top: 62%; left: 25%; width: 50%;height:30%; background-color:#aaa">

      <?php echo Form::open(['route' => ['Periodos.store'],'method'=>'POST','id'=>'elForm']); ?>
...
<?php $__currentLoopData = $no_p; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $per): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<div id="Primer" class="element" style="display: none; position: absolute;top: 5%; left: 45%; width: 20%;height:53%;">
  ...
  <input 
   ...
   onblur="obtenerfechafinf1();" style="width:200px;" value="<?php echo e($no_p[0]->fecha1); ?>" />
   <input
  ...
  <input 
   ...
   onblur="obtenerfechafinf2();" style="width:200px;" value="<?php echo e($no_p[0]->fecha2); ?>" />
   <input
  ...
  <input 
   ...
   onblur="obtenerfechafinf3();" style="width:200px;"value="<?php echo e($no_p[1]->fecha1); ?>" />
   <input
  ...
  <input 
   ...
   onblur="obtenerfechafinf4();" style="width:200px;"value="<?php echo e($no_p[1]->fecha2); ?>" />
   <input
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PrepaTeul\resources\views/Periodos/create.blade.php ENDPATH**/ ?>