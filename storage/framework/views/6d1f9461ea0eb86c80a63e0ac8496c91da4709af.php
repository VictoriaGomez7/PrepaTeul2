...
<body>
	...
	<section style="background: #aaa; width:20%; height: 42%; position: absolute; top: 62%; left: 5%; overflow-y: scroll; text-align:  center;">
		...
		?>
			<?php $__currentLoopData = $M_P_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_P): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
				<?php
				$nomP=$M_P->Nombre;
				$NombresPrimero[]=$nomP; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

			<?php $__currentLoopData = $M_S_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_S): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php
				$nomSE=$M_S->Nombre;
				$NombresSegundo[]=$nomSE; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

			<?php $__currentLoopData = $M_T_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_T): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
				<?php
				$nomT=$M_T->Nombre;
				$NombresTercero[]=$nomT; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

			<?php $__currentLoopData = $M_C_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_C): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php
				$nomC=$M_C->Nombre;
				$NombresCuarto[]=$nomC; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

			<?php $__currentLoopData = $M_Q_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_Q): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?> 
				<?php
				$nomQ=$M_Q->Nombre;
				$NombresQuinto[]=$nomQ; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

			<?php $__currentLoopData = $M_SIX_S; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $M_SIX): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				<?php
				$nomSIX=$M_SIX->Nombre;
				$NombresSexto[]=$nomSIX; ?>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
			...
			<?php $__currentLoopData = $Materias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Materia): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				...
				<?php  $j=$j+1 ?>
				<?php  $i=$i+1 ?>
				<input class="cuadradito" style="background: <?php echo e(($color)); ?>;border: 2px solid #0000000; width: 200px;height: 30px; margin: 5px;" readonly id="arrastrable<?php echo e($j); ?>" draggable="true" ondragstart="start(event)" ondragend="end(event)" value='<?php echo e(($Nombre_Editado)); ?>'>
			<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		...
		<section style=" width:67%; height: 53%; position: absolute; top: 52%; left: 28%">
					...
					<table border="1">
						<tr style="font-size:125%; background: #000080; color: rgb(212, 172, 13);">
							<?php $__currentLoopData = $Docentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Docente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
									...
									?>
									<th><?php echo e($Docente->Nombre); ?></th>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tr>
						<tbody>
							<?php $__currentLoopData = $Docentes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $Docente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

								<td style="background: #aaa"><div  id="cuadro<?php echo e($var[$i]); ?>" ondragenter="return enter(event)" ondragover="return over(event)" ondragleave="return leave(event)" ondrop="return drop(event)"></div>
								</td>
								<?php  $i=$i+1;?>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</tbody>
	...
	<input type="hidden" value="<?php echo e($CadenaDocente); ?>" name="Arreglo2" id="Arreglo2" >
	...
	<div style="background: <?php echo e(($ColorPrimeroExtra)); ?>; position: absolute;top: 107%; left: 11.5%;">Primero</div>
	<div style="background:<?php echo e(($ColorSegundoExtra)); ?>; position: absolute;top: 107%; left: 16%;">Segundo</div>
	<div style="background: <?php echo e(($ColorTerceroExtra)); ?>; position: absolute;top: 107%; left: 21%;">Tercero</div>
	<div style="background:<?php echo e(($ColorCuartoExtra)); ?>; position: absolute;top: 107%; left: 25%;">Cuarto</div>
	<div style="background: <?php echo e(($ColorQuintoExtra)); ?>; position: absolute;top: 107%; left: 29%;">Quinto</div>
	<div style="background: <?php echo e(($ColorSextoExtra)); ?>; position: absolute;top: 107%; left: 33%;">Sexto</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PrepaTeul\resources\views/RegistrarDocentes/asignar.blade.php ENDPATH**/ ?>